...
import {
  ...
  CheckCircle2, XCircle, ThumbsUp, ThumbsDown, Sparkles
} from "lucide-react";
...
export function EmailDiscoveryForm() {
  ...
  async function handleSaveContact() {
    ...
    const selectedPattern = emails.find(e => e.email === selectedEmail);
    ...
    try {
      ...
      setFeedbackMessage("✅ Contact saved successfully!");
      ...
      setFeedbackMessage("❌ Could not save contact");
    }
  }
