...
/**
 * Render the ContactTable component.
 * @returns {unknown} JSX output for ContactTable.
 * @example
 * <ContactTable />
 */
export function ContactTable() {
  ...
  function getStatusBadge(status: string) {
    const variants: Record<ContactStatus, StatusBadgeConfig> = {
    ...
    const typedStatus = status as ContactStatus;
    const config = variants[typedStatus] ?? variants.new;
