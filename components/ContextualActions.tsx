...
/**
 * Render the ContextualActions component.
 * @param {ContextualActionsProps} props - Component props.
 * @returns {unknown} JSX output for ContextualActions.
 * @example
 * <ContextualActions />
 */
...
/**
 * Render the SmartQuickActions component.
 * @param {SmartQuickActionsProps} props - Component props.
 * @returns {unknown} JSX output for SmartQuickActions.
 * @example
 * <SmartQuickActions />
 */
