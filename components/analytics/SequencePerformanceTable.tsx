...
/**
 * Render the SequencePerformanceTable component.
 * @param {SequencePerformanceTableProps} props - Component props.
 * @returns {unknown} JSX output for SequencePerformanceTable.
 * @example
