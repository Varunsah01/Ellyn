...
/**
 * Render the DropdownMenuSubTrigger component.
 * @param {React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & {
    inset?: boolean
...
/**
 * Render the DropdownMenuSubContent component.
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-[120] min-w-[8rem] overflow-hidden rounded-md border border-border bg-popover p-1 text-popover-foreground shadow-lg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
      className
    )}
    {...props}
  />
...
/**
 * Render the DropdownMenuContent component.
...
/**
 * Render the DropdownMenuCheckboxItem component.
...
/**
 * Render the DropdownMenuRadioItem component.
...
/**
 * Render the DropdownMenuLabel component.
 * @param {React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.Label> & {
    inset?: boolean
  }} props - Component props.
 * @returns {JSX.Element} JSX output.
 * @example
...
/**
 * Render the DropdownMenuSeparator component.
 ...
 * @param {React.HTMLAttributes<HTMLSpanElement>} props - Function input.
