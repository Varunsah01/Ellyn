 ...
 * @returns {JSX.Element} JSX output for AnimatedButton.
 * @example
 * <AnimatedButton />
 */
...
/**
 * Render the PulseButton component.
 * @param {AnimatedButtonProps} props - Component props.
 * @returns {unknown} JSX output for PulseButton.
 * @example
 * <PulseButton />
 */
...
/**
 * Render the ShakeButton component.
 * @param {AnimatedButtonProps} props - Component props.
 * @returns {unknown} JSX output for ShakeButton.
 * @example
 * <ShakeButton />
 */
