...
import * as LegacyRoute from '@/app/api/leads/route'
...
/**
 * Handle GET requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for GET /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // GET /api/v1/leads
 * fetch('/api/v1/leads', { method: 'GET' })
 */
export const GET = createVersionedHandler(legacyConfig.GET as any)
/**
 * Handle POST requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for POST /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // POST /api/v1/leads
...
/**
 * Handle PUT requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for PUT /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // PUT /api/v1/leads
 * fetch('/api/v1/leads', { method: 'PUT' })
 */
export const PUT = createVersionedHandler(legacyConfig.PUT as any)
/**
 * Handle PATCH requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for PATCH /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // PATCH /api/v1/leads
 * fetch('/api/v1/leads', { method: 'PATCH' })
 */
export const PATCH = createVersionedHandler(legacyConfig.PATCH as any)
/**
 * Handle DELETE requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for DELETE /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // DELETE /api/v1/leads
 * fetch('/api/v1/leads', { method: 'DELETE' })
 */
export const DELETE = createVersionedHandler(legacyConfig.DELETE as any)
/**
 * Handle OPTIONS requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for OPTIONS /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // OPTIONS /api/v1/leads
 * fetch('/api/v1/leads', { method: 'OPTIONS' })
 */
export const OPTIONS = createVersionedHandler(legacyConfig.OPTIONS as any)
/**
 * Handle HEAD requests for `/api/v1/leads`.
 * @returns {RouteHandler} Versioned route handler for HEAD /api/v1/leads.
 * @throws {AuthenticationError} If the request is not authenticated.
 * @throws {Error} If an unexpected server error occurs.
 * @example
 * // HEAD /api/v1/leads
 * fetch('/api/v1/leads', { method: 'HEAD' })
 */
