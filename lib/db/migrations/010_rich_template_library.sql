-- Migration 010: Rich system template library for job seekers, SMB sales, and general outreach

ALTER TABLE public.email_templates
  ADD COLUMN IF NOT EXISTS use_case TEXT,
  ADD COLUMN IF NOT EXISTS tone TEXT,
  ADD COLUMN IF NOT EXISTS is_system BOOLEAN NOT NULL DEFAULT FALSE,
  ADD COLUMN IF NOT EXISTS variables TEXT[] DEFAULT '{}'::TEXT[],
  ADD COLUMN IF NOT EXISTS tags JSONB DEFAULT '[]'::JSONB;

CREATE INDEX IF NOT EXISTS idx_email_templates_use_case
  ON public.email_templates(use_case);

CREATE UNIQUE INDEX IF NOT EXISTS idx_email_templates_name_is_default_true
  ON public.email_templates(name, is_default)
...
VALUES
  (
    ...
    'Quick question about {{role}} opportunities at {{company}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'role', 'company', 'userName']::TEXT[]
  ),
  (
    NULL,
    'Recruiter Introduction — Tech Role',
    'Referred by LinkedIn — {{role}} candidate',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    ...
    'Fellow {{userSchool}} alum — quick question',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'userSchool', 'company', 'role', 'userName', 'userMajor']::TEXT[]
  ),
  (
    NULL,
...
{{userName}}$$,
  ...
  (
    NULL,
    'Internship Request — Student',
    'Internship inquiry — {{userMajor}} student at {{userSchool}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'company', 'userName', 'userSchool', 'userMajor']::TEXT[]
  ),
  (
    NULL,
    'Re-Engagement After Referral',
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'company', 'role', 'userName']::TEXT[]
  ),
  (
    NULL,
...
{{userName}}$$,
  ...
  (
    NULL,
    'Cold Outreach — Pain-Led',
    '{{company}} + [Your Company] — worth 10 minutes?',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'company', 'userName']::TEXT[]
  ),
  (
    NULL,
    'Executive Sponsor Outreach',
    'Relevant to {{company}}''s Q[X] priorities',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    ...
    '15-min demo — built for teams like {{company}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'userName']::TEXT[]
  ),
  (
    NULL,
    'Referral Ask',
    'Quick favour, {{firstName}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    NULL,
    'Case Study Drop',
    'How [Similar Company] solved [pain] — relevant to {{company}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    NULL,
    'Introduction — New Connection',
    'Connecting from LinkedIn, {{firstName}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    ...
    'Partnership idea — {{company}} + [Your Company]',
    $$Hi {{firstName}},
...
{{userName}}$$,
  ...
  (
    ...
    'Introduction request — {{firstName}}',
    $$Hi {{firstName}},
...
{{userName}}$$,
    ...
    TRUE,
    TRUE,
    ARRAY['firstName', 'fullName', 'company', 'userName']::TEXT[]
  )
ON CONFLICT (name, is_default) WHERE is_default = TRUE DO NOTHING;
